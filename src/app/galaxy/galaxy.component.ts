...
export class GalaxyComponent implements AfterViewInit, OnDestroy {
  ...
  public regenerateGalaxy(): void {
      ...
      if (this.galaxyGroup) {
          ...
          // Dispose of old geometry and material to free up memory
      ...
      // Create a new one with current settings
  ...
  private createGalaxy(): void {
    ...
    const material = new THREE.PointsMaterial({ size: 2.5, sizeAttenuation: true, vertexColors: true, blending: THREE.AdditiveBlending, transparent: true, opacity: 0.8, depthWrite: false });
  ...
  private animate = (): void => {
    this.ngZone.runOutsideAngular(() => {
        ...
        // Use property for rotation speed
