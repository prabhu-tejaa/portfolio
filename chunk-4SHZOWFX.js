...
var environment = {
  production: true,
  emailjs_service_id: "service_chukbge",
  emailjs_template_id: "template_wke6sc9",
  emailjs_public_key: "Y9gKEjAxKWBpaHylR"
};

// src/app/pages/social/social.component.ts
var _c0 = ["rendererContainer"];
function SocialComponent_div_2_p_24_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("error", ctx_r1.submissionStatus.includes("Error"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.submissionStatus, " ");
  }
}
function SocialComponent_div_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 3)(1, "div", 4)(2, "button", 5);
    \u0275\u0275listener("click", function SocialComponent_div_2_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeContactModal());
    });
    \u0275\u0275text(3, "\xD7");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "h2");
    ...
    \u0275\u0275listener("ngSubmit", function SocialComponent_div_2_Template_form_ngSubmit_6_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.sendEmail());
    });
    \u0275\u0275elementStart(7, "div", 7)(8, "label");
    \u0275\u0275text(9, "Subject");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function SocialComponent_div_2_Template_input_ngModelChange_16_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.contactForm.email, $event) || (ctx_r1.contactForm.email = $event);
    ...
    \u0275\u0275text(19, "Message");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "textarea", 11);
    \u0275\u0275twoWayListener("ngModelChange", function SocialComponent_div_2_Template_textarea_ngModelChange_20_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.contactForm.message, $event) || (ctx_r1.contactForm.message = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(23);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(24, SocialComponent_div_2_p_24_Template, 2, 3, "p", 14);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(16);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.contactForm.email);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.contactForm.message);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r1.isLoading);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.isLoading ? "Sending..." : "Send Message", " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.submissionStatus);
  }
}
var SocialComponent = class _SocialComponent {
  ...
  constructor(worldService, cdRef, zone) {
  ...
  ngAfterViewInit() {
    ...
    this.worldService.onInteraction = (event) => {
  ...
  sendEmail() {
    ...
    this.cdRef.markForCheck();
    es_default.send(environment.emailjs_service_id, environment.emailjs_template_id, this.contactForm, environment.emailjs_public_key).then(() => {
  ...
  static \u0275fac = function SocialComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SocialComponent)(\u0275\u0275directiveInject(SocialWorldService), \u0275\u0275directiveInject(ChangeDetectorRef), \u0275\u0275directiveInject(NgZone));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SocialComponent, selectors: [["app-social"]], viewQuery: function SocialComponent_Query(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275viewQuery(_c0, 5);
    }
    if (rf & 2) {
      let _t;
      \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.rendererContainer = _t.first);
    }
  }, decls: 3, vars: 1, consts: [["rendererContainer", ""], [1, "three-container"], ["class", "modal-overlay", 4, "ngIf"], [1, "modal-overlay"], [1, "modal-content", "glass-effect"], [1, "close-btn", 3, "click"], [3, "ngSubmit"], [1, "form-group"], ["type", "text", "value", "Subject: Portfolio Inquiry", "readonly", ""], [1, "required"], ["type", "email", "name", "email", "required", "", "placeholder", "your@email.com", 3, "ngModelChange", "ngModel"], ["name", "message", "rows", "4", "placeholder", "Say hello...", 3, "ngModelChange", "ngModel"], [1, "form-actions"], ["type", "submit", 3, "disabled"], ["class", "status-msg", 3, "error", 4, "ngIf"], [1, "status-msg"]], template: function SocialComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "div", 1, 0);
      \u0275\u0275template(2, SocialComponent_div_2_Template, 25, 5, "div", 2);
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.isModalOpen);
    }
  }, dependencies: [CommonModule, NgIf, FormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, RequiredValidator, NgModel, NgForm], styles: ['\n\n.three-container[_ngcontent-%COMP%] {\n  position: fixed;\n  inset: 0;\n  width: 100vw;\n  height: 100vh;\n  z-index: 1;\n  background: transparent;\n  pointer-events: auto;\n  overflow: hidden;\n  touch-action: none;\n  will-change: transform, opacity;\n}\n.modal-overlay[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 1000;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  backdrop-filter: blur(5px);\n  animation: _ngcontent-%COMP%_fadeIn 0.3s ease-out;\n  background:\n    radial-gradient(\n      circle,\n      rgba(0, 0, 0, 0.4) 0%,\n      rgba(0, 0, 0, 0.9) 100%);\n}\n.glass-effect[_ngcontent-%COMP%] {\n  background: rgba(255, 255, 255, 0.05);\n  backdrop-filter: blur(16px);\n  -webkit-backdrop-filter: blur(16px);\n  border: 1px solid rgba(255, 255, 255, 0.1);\n  box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);\n  color: white;\n}\n.modal-content[_ngcontent-%COMP%] {\n  position: relative;\n  width: 90%;\n  max-width: 500px;\n  padding: 2rem;\n  border-radius: 20px;\n  animation: _ngcontent-%COMP%_slideUp 0.4s cubic-bezier(0.16, 1, 0.3, 1);\n  border: 1px solid rgba(0, 255, 255, 0.2);\n  box-shadow: 0 0 20px rgba(0, 255, 255, 0.1);\n}\n.modal-content[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n  margin-top: 0;\n  margin-bottom: 1.5rem;\n  text-align: center;\n  font-family: "Outfit", sans-serif;\n  letter-spacing: 1px;\n}\n.close-btn[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 15px;\n  right: 20px;\n  background: transparent;\n  border: none;\n  color: rgba(255, 255, 255, 0.7);\n  font-size: 2rem;\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.close-btn[_ngcontent-%COMP%]:hover {\n  color: white;\n}\n.form-group[_ngcontent-%COMP%] {\n  margin-bottom: 1.2rem;\n}\n.form-group[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  display: block;\n  margin-bottom: 0.5rem;\n  font-size: 0.9rem;\n  color: rgba(255, 255, 255, 0.8);\n}\n.form-group[_ngcontent-%COMP%]   input[_ngcontent-%COMP%], \n.form-group[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 12px;\n  background: rgba(0, 0, 0, 0.3);\n  border: 1px solid rgba(255, 255, 255, 0.1);\n  border-radius: 8px;\n  color: white;\n  font-family: inherit;\n  transition:\n    border-color 0.3s,\n    background 0.3s,\n    box-shadow 0.3s;\n  box-sizing: border-box;\n}\n.form-group[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]:focus, \n.form-group[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%]:focus {\n  outline: none;\n  border-color: #00ffff;\n  background: rgba(0, 0, 0, 0.5);\n  box-shadow: 0 0 10px rgba(0, 255, 255, 0.3);\n}\n.form-group[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%] {\n  resize: vertical;\n}\n.form-actions[_ngcontent-%COMP%] {\n  text-align: center;\n  margin-top: 2rem;\n}\n.form-actions[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  padding: 12px 30px;\n  background:\n    linear-gradient(\n      45deg,\n      #00ffff,\n      #0088ff);\n  border: none;\n  border-radius: 50px;\n  color: black;\n  font-weight: bold;\n  cursor: pointer;\n  transition: transform 0.2s, box-shadow 0.2s;\n}\n.form-actions[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:hover {\n  transform: translateY(-2px);\n  box-shadow: 0 5px 15px rgba(0, 255, 255, 0.3);\n}\n.form-actions[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:disabled {\n  opacity: 0.7;\n  cursor: not-allowed;\n  transform: none;\n}\n.status-msg[_ngcontent-%COMP%] {\n  text-align: center;\n  margin-top: 1rem;\n  font-size: 0.9rem;\n  color: #4caf50;\n}\n.status-msg.error[_ngcontent-%COMP%] {\n  color: #f44336;\n}\n@keyframes _ngcontent-%COMP%_fadeIn {\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 1;\n  }\n}\n@keyframes _ngcontent-%COMP%_slideUp {\n  from {\n    transform: translateY(50px);\n    opacity: 0;\n  }\n  to {\n    transform: translateY(0);\n    opacity: 1;\n  }\n}\n/*# sourceMappingURL=social.component.css.map */'], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SocialComponent, [{
    type: Component,
    args: [{ selector: "app-social", standalone: true, imports: [CommonModule, FormsModule], changeDetection: ChangeDetectionStrategy.OnPush, template: `<div #rendererContainer class="three-container"></div>\r
\r
<div class="modal-overlay" *ngIf="isModalOpen">\r
    <div class="modal-content glass-effect">\r
        <button class="close-btn" (click)="closeContactModal()">&times;</button>\r
        <h2>Contact Me</h2>\r
        <form (ngSubmit)="sendEmail()">\r
            <div class="form-group">\r
                <label>Subject</label>\r
                <input type="text" value="Subject: Portfolio Inquiry" readonly>\r
            </div>\r
            <div class="form-group">\r
                <label>Email <span class="required">*</span></label>\r
                <input type="email" [(ngModel)]="contactForm.email" name="email" required placeholder="your@email.com">\r
            </div>\r
            <div class="form-group">\r
                <label>Message</label>\r
                <textarea [(ngModel)]="contactForm.message" name="message" rows="4" placeholder="Say hello..."></textarea>\r
            </div>\r
\r
            <div class="form-actions">\r
                <button type="submit" [disabled]="isLoading">\r
                    {{ isLoading ? 'Sending...' : 'Send Message' }}\r
                </button>\r
            </div>\r
\r
            <p class="status-msg" *ngIf="submissionStatus" [class.error]="submissionStatus.includes('Error')">\r
                {{ submissionStatus }}\r
            </p>\r
        </form>\r
    </div>\r
</div>`, styles: ['/* src/app/pages/social/social.component.scss */\n.three-container {\n  position: fixed;\n  inset: 0;\n  width: 100vw;\n  height: 100vh;\n  z-index: 1;\n  background: transparent;\n  pointer-events: auto;\n  overflow: hidden;\n  touch-action: none;\n  will-change: transform, opacity;\n}\n.modal-overlay {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 1000;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  backdrop-filter: blur(5px);\n  animation: fadeIn 0.3s ease-out;\n  background:\n    radial-gradient(\n      circle,\n      rgba(0, 0, 0, 0.4) 0%,\n      rgba(0, 0, 0, 0.9) 100%);\n}\n.glass-effect {\n  background: rgba(255, 255, 255, 0.05);\n  backdrop-filter: blur(16px);\n  -webkit-backdrop-filter: blur(16px);\n  border: 1px solid rgba(255, 255, 255, 0.1);\n  box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);\n  color: white;\n}\n.modal-content {\n  position: relative;\n  width: 90%;\n  max-width: 500px;\n  padding: 2rem;\n  border-radius: 20px;\n  animation: slideUp 0.4s cubic-bezier(0.16, 1, 0.3, 1);\n  border: 1px solid rgba(0, 255, 255, 0.2);\n  box-shadow: 0 0 20px rgba(0, 255, 255, 0.1);\n}\n.modal-content h2 {\n  margin-top: 0;\n  margin-bottom: 1.5rem;\n  text-align: center;\n  font-family: "Outfit", sans-serif;\n  letter-spacing: 1px;\n}\n.close-btn {\n  position: absolute;\n  top: 15px;\n  right: 20px;\n  background: transparent;\n  border: none;\n  color: rgba(255, 255, 255, 0.7);\n  font-size: 2rem;\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.close-btn:hover {\n  color: white;\n}\n.form-group {\n  margin-bottom: 1.2rem;\n}\n.form-group label {\n  display: block;\n  margin-bottom: 0.5rem;\n  font-size: 0.9rem;\n  color: rgba(255, 255, 255, 0.8);\n}\n.form-group input,\n.form-group textarea {\n  width: 100%;\n  padding: 12px;\n  background: rgba(0, 0, 0, 0.3);\n  border: 1px solid rgba(255, 255, 255, 0.1);\n  border-radius: 8px;\n  color: white;\n  font-family: inherit;\n  transition:\n    border-color 0.3s,\n    background 0.3s,\n    box-shadow 0.3s;\n  box-sizing: border-box;\n}\n.form-group input:focus,\n.form-group textarea:focus {\n  outline: none;\n  border-color: #00ffff;\n  background: rgba(0, 0, 0, 0.5);\n  box-shadow: 0 0 10px rgba(0, 255, 255, 0.3);\n}\n.form-group textarea {\n  resize: vertical;\n}\n.form-actions {\n  text-align: center;\n  margin-top: 2rem;\n}\n.form-actions button {\n  padding: 12px 30px;\n  background:\n    linear-gradient(\n      45deg,\n      #00ffff,\n      #0088ff);\n  border: none;\n  border-radius: 50px;\n  color: black;\n  font-weight: bold;\n  cursor: pointer;\n  transition: transform 0.2s, box-shadow 0.2s;\n}\n.form-actions button:hover {\n  transform: translateY(-2px);\n  box-shadow: 0 5px 15px rgba(0, 255, 255, 0.3);\n}\n.form-actions button:disabled {\n  opacity: 0.7;\n  cursor: not-allowed;\n  transform: none;\n}\n.status-msg {\n  text-align: center;\n  margin-top: 1rem;\n  font-size: 0.9rem;\n  color: #4caf50;\n}\n.status-msg.error {\n  color: #f44336;\n}\n@keyframes fadeIn {\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 1;\n  }\n}\n@keyframes slideUp {\n  from {\n    transform: translateY(50px);\n    opacity: 0;\n  }\n  to {\n    transform: translateY(0);\n    opacity: 1;\n  }\n}\n/*# sourceMappingURL=social.component.css.map */\n'] }]
  }], () => [{ type: SocialWorldService }, { type: ChangeDetectorRef }, { type: NgZone }], { rendererContainer: [{
    type: ViewChild,
    args: ["rendererContainer"]
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SocialComponent, { className: "SocialComponent", filePath: "src/app/pages/social/social.component.ts", lineNumber: 16 });
})();
export {
  SocialComponent
};
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-4SHZOWFX.js.map
